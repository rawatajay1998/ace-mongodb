...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const title = `Rental Properties in ${capitalizedCity} | Ace Elite Properties`;
  const description = `Find rental apartments, villas, and homes in ${capitalizedCity}. Discover the best rental opportunities with Ace Elite Properties.`;
